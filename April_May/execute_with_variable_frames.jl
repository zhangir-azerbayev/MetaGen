...
include("inference_with_variable_frames.jl")
...
(traces, time_PF) = @timed particle_filter(num_particles, n_percepts, n_frames, ambiguous_percept, gt_choices, num_samples, beta_mean, false);
...
(traces, time_PF) = @timed particle_filter(num_particles, n_percepts, n_frames, ambiguous_percept, gt_choices, num_samples, beta_mean, true);
