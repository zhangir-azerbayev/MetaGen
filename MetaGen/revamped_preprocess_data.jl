...
function jacccard_sim_2D(num_videos::Int64, num_frames::Int64, dict::Any,
    ...
    return sim_online, sim_retrospective, sim_lesioned, sim_NN
end
...
new_df = DataFrame(video = 1:num_videos, sim_online = sim_online, sim_retrospective = sim_retrospective, sim_lesioned = sim_lesioned, sim_NN = sim_NN)
